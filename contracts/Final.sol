...
////////////////////////////////////////////////////////////////functions related to admin
    ...
    // function addChallan(string calldata _LicenseID,string calldata _Name,string calldata _CNIC,VehicleType _Car,string calldata _carPlate,uint[] memory _voilatedRules,string calldata _timeStamp) public{
    //     require(TP[msg.sender]==true);
    //     uint VoilationFee=0;
    //     for(uint i=0;i<_voilatedRules.length;i++){
    //         VoilationFee+=RuleList[i].Fine;
    //     }
